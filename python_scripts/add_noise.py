...
required.add_argument('-i','--input',type=str,help='Path to directory containing images to be manipulated.')
required.add_argument('-o','--output',type=str,help='Path to directory to put the manipulated images into.')
